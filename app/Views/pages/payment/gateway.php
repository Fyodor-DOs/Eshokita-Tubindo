        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="text-center mb-4">
                    <div class="border rounded p-3 d-inline-block bg-white" id="qr-container">
                        <div id="qr-code" style="width: 180px; height: 180px; display: flex; align-items: center; justify-content: center;">
                ...
                <div class="mb-4">
                    <div class="btn-group w-100 mb-3" role="group">
                        <button type="button" class="btn btn-outline-primary va-bank active" data-bank="bca">BCA</button>
                        <button type="button" class="btn btn-outline-primary va-bank" data-bank="bni">BNI</button>
                        <button type="button" class="btn btn-outline-primary va-bank" data-bank="mandiri">Mandiri</button>
                    ...
                    <div class="border rounded p-3 text-center bg-light">
                        ...
                        <h4 class="font-monospace mb-2" id="va-number">8277 0<?= str_pad($invoice['id_invoice'], 10, '0', STR_PAD_LEFT) ?></h4>
                ...
                <div class="mb-4">
                    <div class="list-group">
                        <label class="list-group-item d-flex align-items-center ewallet-option">
                            <input type="radio" name="ewallet" value="gopay" class="me-2" checked>
                            <span class="badge bg-success me-2">GoPay</span>
                            <span>Gojek E-Wallet</span>
                        </label>
                        <label class="list-group-item d-flex align-items-center ewallet-option">
                            <input type="radio" name="ewallet" value="shopeepay" class="me-2">
                            <span class="badge bg-danger me-2">ShopeePay</span>
                            <span>Shopee E-Wallet</span>
                        </label>
                        <label class="list-group-item d-flex align-items-center ewallet-option">
                            <input type="radio" name="ewallet" value="linkaja" class="me-2">
                            <span class="badge bg-danger me-2">LinkAja</span>
                            <span>Telkomsel E-Wallet</span>
                        </label>
                    </div>
                </div>
                ...
                <a href="<?= base_url('/payment/create/' . $invoice['id_invoice']) ?>" class="btn btn-outline-secondary w-100">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    try {
        ...
        const qrData = 'ESHOKITA-<?= $invoice['id_invoice'] ?>-<?= $amount ?>-' + Date.now();
        ...
        if (typeof QRCode !== 'undefined') {
            ...
            qrContainer.innerHTML = '<div class="p-4 bg-light border"><strong>QR Code</strong><br><small class="text-muted">' + qrData + '</small></div>';
        }
    } catch (e) {
    ...
    if (btnCopyVa) {
        btnCopyVa.addEventListener('click', function() {
            ...
            navigator.clipboard.writeText(vaNumber).then(function() {
                ...
                prompt('Salin nomor VA:', vaNumber);
            });
        });
    }
    ...
    btnPay.addEventListener('click', function() {
        ...
        fetch('<?= base_url('/payment/process/' . $invoice['id_invoice']) ?>', {
            method: 'POST',
            headers: { 
        ...
        .then(function(result) {
            ...
            if (result.success) {
                ...
                statusMessage.innerHTML = '<i class="bi bi-check-circle-fill"></i> <strong>Pembayaran Berhasil!</strong><br>Redirecting...';
                ...
                if (typeof Swal !== 'undefined') {
                    ...
                    alert('Pembayaran Berhasil! Pembayaran sebesar Rp <?= number_format($amount, 0, ',', '.') ?> telah diterima.');
                    window.location.href = '<?= base_url('/invoice') ?>';
                }
            } else {
        ...
        .catch(function(err) {
            ...
            statusMessage.innerHTML = '<i class="bi bi-x-circle-fill"></i> <strong>Gagal:</strong> ' + err.message;
