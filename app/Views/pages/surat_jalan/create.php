...
<?= view('components/Breadcrumb', ['segment1' => 'surat-jalan', 'segment2' => 'create']) ?>

<div class="alert alert-info">
    <i class="bi bi-info-circle"></i>
    <strong>Cara Kerja Surat Jalan:</strong>
    <ul class="mb-0 mt-2">
        <li>Pilih No. BON Pengiriman yang belum dibuat surat jalannya</li>
        <li>Sistem akan otomatis membuat surat jalan terpisah untuk setiap customer berbeda dalam 1 BON tersebut</li>
        <li>Setiap customer akan mendapatkan halaman surat jalan sendiri dengan produk mereka masing-masing</li>
        <li>Anda bisa download/print surat jalan per customer secara terpisah</li>
    </ul>
</div>
...
<div class="alert alert-warning">
    ...
    Semua pengiriman sudah dibuatkan surat jalan. Silakan buat pengiriman baru terlebih dahulu.
</div>
<?php else: ?>
<form method="post" action="<?= site_url('surat-jalan/create') ?>" id="formSuratJalan">
    <?= csrf_field() ?>
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <small class="text-muted">Hanya menampilkan BON yang belum dibuat surat jalannya</small>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="tanggal" class="form-label">Tanggal Surat Jalan <span class="text-danger">*</span></label>
        ...
        <div class="card-footer bg-white">
            <div class="d-flex justify-content-between align-items-center">
                <a href="<?= base_url('/surat-jalan') ?>" class="btn btn-secondary">Batal</a>
                <button type="submit" class="btn btn-primary"><i class="bi bi-plus-circle"></i> Buat Surat Jalan</button>
            </div>
        </div>
    </div>
</form>
    ...
    $('#id_pengiriman').on('change', async function(){
        ...
        try {
            ...
            if (data.success && data.data && data.data.length > 0) {
                ...
                html += '<p class=\"text-muted small\">Sistem akan membuat surat jalan terpisah untuk setiap customer berbeda dalam BON ini</p>';
